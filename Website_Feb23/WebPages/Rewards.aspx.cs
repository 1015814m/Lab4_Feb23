...
public partial class Rewards : System.Web.UI.Page
{
    ...
    protected void btnSelect_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            tran = new Transaction(findMaxID(),FindCost(id),DateTime.Now,FindID(user.EmpLoginID),Convert.ToInt32(id));
    ...
    protected void postTransaction(Transaction a)
    {
        try
        {
            ...
            insert.Parameters.AddWithValue("@PostTime", a.PurchaseTime);
            insert.Parameters.AddWithValue("@NumOfLikes", 0);
            insert.Parameters.AddWithValue("@TransactionID", a.TransactionID);
